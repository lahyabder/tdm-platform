...
import { Target, Eye, Shield, Zap, Radio, Globe } from 'lucide-react';

export function AboutClient({ locale }: { locale: string }) {
    ...
    return (
        <main className="min-h-screen pb-32 pt-20 bg-brand-dark relative waves-pattern selection:bg-brand-green selection:text-white">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 start-1/2 -translate-x-1/2 w-full h-[800px] bg-gradient-to-b from-brand-green/10 via-brand-dark to-transparent"></div>
                <div className="absolute top-[20%] end-[-10%] w-[600px] h-[600px] bg-brand-yellow/5 blur-[150px] rounded-full animate-pulse"></div>
            </div>
                    ...
                    <div className="premium-card p-1 md:p-2 group">
                        <div className="bg-slate-950/40 rounded-[2.4rem] p-6 md:p-8 relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 opacity-10 pointer-events-none">
                                <div className="absolute top-0 end-0 w-full h-full border-[1px] border-white/10 rounded-full scale-150 -translate-y-1/2 translate-x-1/2"></div>
                            </div>
