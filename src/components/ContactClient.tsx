...
export function ContactClient({ locale }: { locale: string }) {
    ...
    return (
        <main className="min-h-screen pb-32 pt-28 bg-brand-dark waves-pattern relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 start-0 w-[500px] h-[500px] bg-brand-green/5 blur-[120px] rounded-full"></div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-8">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-3">
                                                <label htmlFor="contact-name" className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.form.name}</label>
                                                <input id="contact-name" required className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 text-white font-bold focus:border-brand-green focus:bg-white/10 outline-none transition-all" placeholder="Mohamed Vall" />
                                            </div>
                                            <div className="space-y-3">
                                                <label htmlFor="contact-email" className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.form.email}</label>
                                                <input id="contact-email" required type="email" className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 text-white font-bold focus:border-brand-green focus:bg-white/10 outline-none transition-all" placeholder="mohamed@tdm.mr" />
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <label htmlFor="contact-subject" className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.form.subject}</label>
                                            <input id="contact-subject" required className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 text-white font-bold focus:border-brand-green focus:bg-white/10 outline-none transition-all" />
                                        </div>
                                        <div className="space-y-3">
                                            <label htmlFor="contact-message" className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.form.message}</label>
                                            <textarea id="contact-message" required rows={5} className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 text-white font-bold focus:border-brand-green focus:bg-white/10 outline-none transition-all resize-none"></textarea>
                                        </div>
