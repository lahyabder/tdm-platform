        ...
        <main className="min-h-screen pb-32 pt-28 bg-brand-dark waves-pattern relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {Array.from(new Map(articles.map(a => [a.id, a])).values()).map((article, idx) => {
                    ...
                    <>
                        ...
                        >
                            <div className="bg-slate-950/60 rounded-[2.4rem] h-full overflow-y-auto custom-scrollbar relative">
                                <button
                                    onClick={() => setSelectedArticle(null)}
                                    className="absolute top-8 end-8 z-[130] w-12 h-12 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-white flex items-center justify-center hover:bg-brand-red transition-all group"
                                >
                                ...
                                <div className="h-[400px] md:h-[600px] relative bg-black flex items-center justify-center overflow-hidden">
                                    ...
                                    <div className="absolute bottom-12 start-12 end-12 max-w-4xl">
