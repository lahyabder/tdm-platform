...
export function ServicesClient({ locale }: { locale: string }) {
    ...
    return (
        <main className="min-h-screen pb-32 pt-28 bg-brand-dark waves-pattern relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 end-0 w-[600px] h-[600px] bg-brand-green/5 blur-[120px] rounded-full"></div>
                <div className="absolute bottom-0 start-0 w-[600px] h-[600px] bg-brand-yellow/5 blur-[120px] rounded-full"></div>
            </div>
                        ...
                        >
                            <Link href={`/${locale}/services/${item.id}`} className="group block h-full">
                                <div className="premium-card h-full p-10 flex flex-col hover:bg-white/[0.04] relative overflow-hidden">
                                    {/* Decoration */}
                                    <div className="absolute top-0 end-0 w-32 h-32 bg-brand-green/5 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2"></div>
